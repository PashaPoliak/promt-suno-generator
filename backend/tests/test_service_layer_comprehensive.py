...
class TestPromptService:
    """Comprehensive tests for the prompt service layer"""
    ...
    async def test_create_prompt_with_all_fields(self, db_session):
    ...
    async def test_create_prompt_with_partial_data(self, db_session):
...
class TestTemplateService:
    """Comprehensive tests for the template service layer"""
    ...
    async def test_create_template_with_all_fields(self, db_session):
    ...
    async def test_create_template_required_fields_only(self, db_session):
...
class TestCategoryService:
    """Comprehensive tests for the category service layer"""
...
class TestTagService:
    """Comprehensive tests for the tag service layer"""
    ...
    async def test_create_tag_with_all_fields(self, db_session):
        """Test creating a new tag with all fields"""
        tag_data = TagCreate(
            name="Test Tag",
    ...
    async def test_create_tag_required_fields_only(self, db_session):
    ...
    async def test_search_tags(self, db_session):
        ...
        assert len(results) >= 1
        assert all(tag["tag_type"] == "genre" for tag in [{"name": t.name, "tag_type": t.tag_type} for t in results])